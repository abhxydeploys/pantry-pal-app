...
import { Loader2, Mail, KeyRound, LogIn, UserPlus, AlertTriangle, UtensilsCrossed, Carrot, ChefHat, Clock } from 'lucide-react';
...
const GoogleIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2">
    <path fill="#4285F4" d="M21.35 12.08c0-.79-.07-1.55-.2-2.29H12v4.35h5.24c-.22 1.41-.86 2.63-1.85 3.44v2.79h3.58c2.09-1.93 3.3-4.78 3.3-8.29z" />
    <path fill="#34A853" d="M12 22c3.24 0 5.95-1.07 7.92-2.9l-3.58-2.79c-1.07.72-2.43 1.15-4.34 1.15-3.33 0-6.15-2.24-7.15-5.26H1.24v2.88C3.21 19.38 7.27 22 12 22z" />
    <path fill="#FBBC05" d="M4.85 14.28c-.24-.72-.37-1.49-.37-2.28s.13-1.56.37-2.28V6.84H1.24C.46 8.35 0 10.12 0 12s.46 3.65 1.24 5.16l3.61-2.88z" />
    <path fill="#EA4335" d="M12 4.84c1.77 0 3.35.61 4.62 1.83l3.13-3.13C17.95.83 15.24 0 12 0 7.27 0 3.21 2.62 1.24 6.84l3.61 2.88C5.85 7.08 8.67 4.84 12 4.84z" />
  </svg>
);
  ...
  return (
    <main className="w-full lg:grid lg:min-h-screen lg:grid-cols-2">
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        />
        <div className="relative z-20 flex items-center text-3xl font-bold font-headline">
          ...
          <div className="space-y-4 text-lg">
              ...
              <div className="space-y-6 pt-6 border-t border-primary-foreground/20">
                  <div className="flex items-start gap-4">
                      <div className="bg-primary-foreground/10 p-2 rounded-full"><Carrot className="w-5 h-5" /></div>
                      <div>
                  ...
                  <div className="flex items-start gap-4">
                      <div className="bg-primary-foreground/10 p-2 rounded-full"><Clock className="w-5 h-5" /></div>
                      <div>
      ...
      <div className="flex items-center justify-center py-12">
        <Card className="w-full max-w-md shadow-none border-none lg:shadow-2xl lg:border">
                ...
                <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4 pt-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center text-sm">
                      {loginForm.formState.errors.password && <p className="text-destructive">{loginForm.formState.errors.password.message}</p>}
                      <Button type="button" variant="link" className="h-auto p-0 font-medium ml-auto" onClick={handlePasswordReset} disabled={isLoading}>
                        Forgot Password?
                      </Button>
                    </div>
                  </div>
              ...
              <TabsContent value="signup">
                <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4 pt-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                      <Input id="signup-confirmPassword" type="password" placeholder="••••••••" className="pl-10" {...signupForm.register('confirmPassword')} />
                    </div>
